  ...
  <div className="flex-1 justify-start items-start">
    ...
    {items.map((item, i) => (
      <p
        ...
        font-normal text-base cursor-pointer dark:hover:text-nft-gray-1 hover:text-nft-black-1 my-3
        "
      >{item}
      </p>
    ))}
    ...
    >
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col  sm:px-4 px-16">
        ...
        <div className="flexStart flex-1 flex-col">
          ...
          >
            <input
              ...
              className="h-full flex-1 w-full dark:bg-nft-black-2 bg-white px-4 rounded-md dark:text-white text-nft-black-1
        ...
        <div className="flex-1 flexBetweenStart flex-wrap ml-10 md:ml-0 md:mt-8">
          <FooterLinks heading="CryptoKet" items={['Explore', 'How it works', 'Сontact us']} />
      ...
      <div className="flexCenter w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray-1 sm:px-4 px-16">
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          ...
          <div className="flex flex-row sm:mt-4">
            {[images.instagram, images.twitter, images.telegram, images.discord].map((item, i) => (
